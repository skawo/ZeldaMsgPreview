...
namespace ZeldaMsgPreview
{
    public static class GameData
    {
        ...
        {
            { OcarinaControlCode.PLAYER,          "Player" },
        ...
        {
            {MajoraControlCode.PLAYER,                              "Player"},
            ...
            {MajoraControlCode.BOMBER_CODE_PROMPT,                  "11111" },
            ...
            {MajoraControlCode.HS_TIME_BOAT_ARCHERY,                "00\"10\'" },
            {MajoraControlCode.HS_TIME_PLAYER_LOTTERY,              "00\"00\'" },
            ...
            {MajoraControlCode.DEKU_PLAYGROUND_PLAYER_DAY1,         "Player"},
            {MajoraControlCode.DEKU_PLAYGROUND_PLAYER_DAY2,         "Player"},
            {MajoraControlCode.DEKU_PLAYGROUND_PLAYER_DAY3,         "Player"},
            {MajoraControlCode.HS_UNK2,                             "99'99\"99" },
            {MajoraControlCode.HS_UNK3,                             "10" },
        };
